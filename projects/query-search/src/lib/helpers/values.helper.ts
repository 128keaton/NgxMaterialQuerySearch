...
export function valueContains(value: any, searchValue: string) {
...
export function handleRawValues(rawValues: any[], searchValue: string | null) {
...
export function handleReturnValues(values: any[], maxResults: number | undefined) {
...
export function handleValueSelected(value: any, selectedValues: any[]) {
 ...
 * @param multiSelect
 */
export function toggleValueSelection(value: any | ProvidedValue,
